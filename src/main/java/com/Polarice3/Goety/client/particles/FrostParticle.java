...
public class FrostParticle extends ReversibleParticle {
    private final SpriteSet spriteSet;
    public boolean isBig = false;

    protected FrostParticle(ClientLevel world, double x, double y, double z, double vx, double vy, double vz, SpriteSet spriteSet) {
        super(world, x, y, z);
    ...
    public void tick() {
        ...
        if (!this.removed) {
            ...
            ParticleOptions ground = ParticleTypes.SNOWFLAKE;
            if (this.isBig) {
                ground = ParticleTypes.POOF;
            }
            if (this.onGround) {
    ...
    public static class Provider implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType typeIn, ClientLevel worldIn, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed) {
            FrostParticle flameParticle = new FrostParticle(worldIn, x, y, z, xSpeed, ySpeed, zSpeed, this.spriteSet);
