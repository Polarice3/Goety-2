...
public class FireParticle extends ReversibleParticle {
   ...
   public static class ReversibleProvider implements ParticleProvider<SimpleParticleType> {
      ...
      public Particle createParticle(SimpleParticleType p_106838_, ClientLevel p_106839_, double p_106840_, double p_106841_, double p_106842_, double p_106843_, double p_106844_, double p_106845_) {
         FireParticle fireParticle = new FireParticle(p_106839_, p_106840_, p_106841_, p_106842_, p_106843_, p_106844_, p_106845_, this.sprite);
         fireParticle.reversed = p_106839_.getRandom().nextBoolean();
         return fireParticle;
      }
   }

   public static class ReversedProvider implements ParticleProvider<SimpleParticleType> {
      private final SpriteSet sprite;

      public ReversedProvider(SpriteSet p_106827_) {
         this.sprite = p_106827_;
      }

      public Particle createParticle(SimpleParticleType p_106838_, ClientLevel p_106839_, double p_106840_, double p_106841_, double p_106842_, double p_106843_, double p_106844_, double p_106845_) {
         FireParticle fireParticle = new FireParticle(p_106839_, p_106840_, p_106841_, p_106842_, p_106843_, p_106844_, p_106845_, this.sprite);
         fireParticle.reversed = true;
         return fireParticle;
      }
   }
   ...
   public static class SmallReversibleProvider implements ParticleProvider<SimpleParticleType> {
      ...
      public SmallReversibleProvider(SpriteSet p_172113_) {
         this.sprite = p_172113_;
      }
      ...
      public Particle createParticle(SimpleParticleType p_172124_, ClientLevel p_172125_, double p_172126_, double p_172127_, double p_172128_, double p_172129_, double p_172130_, double p_172131_) {
         FireParticle flameparticle = new FireParticle(p_172125_, p_172126_, p_172127_, p_172128_, p_172129_, p_172130_, p_172131_, this.sprite);
         flameparticle.scale(0.5F);
         flameparticle.reversed = p_172125_.getRandom().nextBoolean();
         return flameparticle;
      }
   }

   public static class SmallReversedProvider implements ParticleProvider<SimpleParticleType> {
      private final SpriteSet sprite;

      public SmallReversedProvider(SpriteSet p_172113_) {
         this.sprite = p_172113_;
      }
