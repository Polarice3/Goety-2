...
public class ReaperModel<T extends AbstractReaper> extends HierarchicalModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition right_bone = right_arm.addOrReplaceChild("right_bone", CubeListBuilder.create().texOffs(32, 16).mirror().addBox(-1.5F, -2.0F, -0.5F, 2.0F, 12.0F, 2.0F, new CubeDeformation(-0.01F)).mirror(false), PartPose.offset(0.5F, 0.0F, -0.5F));

		PartDefinition left_arm = Ghost.addOrReplaceChild("left_arm", CubeListBuilder.create(), PartPose.offset(6.0F, -22.0F, 0.0F));

		PartDefinition left_robe = left_arm.addOrReplaceChild("left_robe", CubeListBuilder.create().texOffs(16, 16).addBox(-2.0F, -3.0F, -2.0F, 4.0F, 14.0F, 4.0F, new CubeDeformation(0.0F))
				.texOffs(16, 34).addBox(-2.0F, -3.0F, 2.0F, 4.0F, 14.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0F, 0.0F));

		PartDefinition left_bone = left_arm.addOrReplaceChild("left_bone", CubeListBuilder.create().texOffs(32, 16).addBox(-1.5F, -2.0F, -0.5F, 2.0F, 12.0F, 2.0F, new CubeDeformation(-0.01F)), PartPose.offset(0.5F, 0.0F, -0.5F));

		PartDefinition scythe = left_bone.addOrReplaceChild("scythe", CubeListBuilder.create(), PartPose.offsetAndRotation(-0.57F, 9.32F, 1.0F, 0.0F, 1.5708F, 0.0F));

		PartDefinition ominous_scythe = scythe.addOrReplaceChild("ominous_scythe", CubeListBuilder.create().texOffs(6, 52).mirror().addBox(0.32F, -11.32F, -0.5F, 4.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false)
				.texOffs(0, 52).addBox(4.32F, -10.32F, -0.5F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
				.texOffs(16, 52).addBox(-1.68F, -11.32F, -0.5F, 2.0F, 3.0F, 1.0F, new CubeDeformation(0.0F))
				.texOffs(24, 65).addBox(-2.68F, -10.32F, -0.5F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F))
				.texOffs(22, 52).addBox(-3.68F, -10.32F, -0.5F, 1.0F, 3.0F, 1.0F, new CubeDeformation(0.0F))
				.texOffs(26, 52).addBox(-4.68F, -9.32F, -0.5F, 1.0F, 3.0F, 1.0F, new CubeDeformation(0.0F))
				.texOffs(0, 54).addBox(-5.68F, -8.32F, -0.5F, 1.0F, 3.0F, 1.0F, new CubeDeformation(0.0F))
				.texOffs(4, 55).addBox(-6.68F, -8.32F, -0.5F, 1.0F, 7.0F, 1.0F, new CubeDeformation(0.0F))
				.texOffs(8, 55).addBox(-7.68F, -7.32F, -0.5F, 1.0F, 5.0F, 1.0F, new CubeDeformation(0.0F))
				.texOffs(12, 56).addBox(-9.68F, -6.32F, -0.5F, 2.0F, 5.0F, 1.0F, new CubeDeformation(0.0F))
				.texOffs(18, 56).addBox(-5.68F, -3.32F, -0.5F, 2.0F, 3.0F, 1.0F, new CubeDeformation(0.0F))
				.texOffs(24, 56).addBox(-3.68F, -2.32F, -0.5F, 3.0F, 3.0F, 1.0F, new CubeDeformation(0.0F))
				.texOffs(0, 58).addBox(-0.68F, -1.32F, -0.5F, 1.0F, 5.0F, 1.0F, new CubeDeformation(0.0F))
				.texOffs(0, 64).addBox(-1.68F, 1.68F, -0.5F, 1.0F, 3.0F, 1.0F, new CubeDeformation(0.0F))
				.texOffs(4, 63).addBox(-2.68F, 2.68F, -0.5F, 1.0F, 3.0F, 1.0F, new CubeDeformation(0.0F))
				.texOffs(8, 61).addBox(-3.68F, 3.68F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
				.texOffs(12, 62).addBox(0.32F, -0.32F, -0.5F, 1.0F, 3.0F, 1.0F, new CubeDeformation(0.0F))
				.texOffs(16, 62).addBox(1.32F, 0.68F, -0.5F, 1.0F, 4.0F, 1.0F, new CubeDeformation(0.0F))
				.texOffs(20, 60).addBox(2.32F, 1.68F, -0.5F, 1.0F, 5.0F, 1.0F, new CubeDeformation(0.0F))
				.texOffs(24, 60).addBox(3.32F, 3.68F, -0.5F, 1.0F, 4.0F, 1.0F, new CubeDeformation(0.0F))
				.texOffs(28, 60).addBox(4.32F, 5.68F, -0.5F, 1.0F, 4.0F, 1.0F, new CubeDeformation(0.0F))
				.texOffs(8, 63).addBox(5.32F, 6.68F, -0.5F, 1.0F, 5.0F, 1.0F, new CubeDeformation(0.0F))
				.texOffs(12, 66).addBox(6.32F, 8.68F, -0.5F, 1.0F, 4.0F, 1.0F, new CubeDeformation(0.0F))
				.texOffs(16, 67).addBox(7.32F, 10.68F, -0.5F, 1.0F, 3.0F, 1.0F, new CubeDeformation(0.0F))
				.texOffs(20, 66).addBox(8.32F, 11.68F, -0.5F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(4.0F, 0.0F, -0.25F, 0.0F, 0.0F, 2.2689F));
		...
		PartDefinition bone = body.addOrReplaceChild("bone", CubeListBuilder.create().texOffs(44, 52).addBox(-3.5F, -1.0F, -2.5F, 7.0F, 9.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0F, 0.0F));
	...
	public static final AnimationDefinition IDLE = AnimationDefinition.Builder.withLength(4.0F).looping()
			...
			.addAnimation("scythe", new AnimationChannel(AnimationChannel.Targets.POSITION,
					...
					new Keyframe(4.0F, KeyframeAnimations.posVec(0.0F, 0.0F, -6.0F), AnimationChannel.Interpolations.CATMULLROM)
			))
	...
	public static final AnimationDefinition ATTACK = AnimationDefinition.Builder.withLength(1.1667F)
			...
			.addAnimation("scythe", new AnimationChannel(AnimationChannel.Targets.ROTATION,
					new Keyframe(0.0F, KeyframeAnimations.degreeVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
					new Keyframe(0.4167F, KeyframeAnimations.degreeVec(90.0F, -7.5F, 75.0F), AnimationChannel.Interpolations.LINEAR),
					new Keyframe(0.5F, KeyframeAnimations.degreeVec(90.0F, -7.5F, 75.0F), AnimationChannel.Interpolations.CATMULLROM),
					new Keyframe(0.6667F, KeyframeAnimations.degreeVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
					new Keyframe(1.1667F, KeyframeAnimations.degreeVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM)
			))
			.addAnimation("scythe", new AnimationChannel(AnimationChannel.Targets.POSITION,
					new Keyframe(0.0F, KeyframeAnimations.posVec(0.0F, 0.0F, -6.0F), AnimationChannel.Interpolations.CATMULLROM),
					new Keyframe(0.4167F, KeyframeAnimations.posVec(0.0F, -2.0F, -10.0F), AnimationChannel.Interpolations.LINEAR),
					new Keyframe(0.5F, KeyframeAnimations.posVec(0.0F, -2.0F, -10.0F), AnimationChannel.Interpolations.CATMULLROM),
					new Keyframe(0.6667F, KeyframeAnimations.posVec(0.0F, 6.0F, -9.0F), AnimationChannel.Interpolations.CATMULLROM),
					new Keyframe(1.1667F, KeyframeAnimations.posVec(0.0F, 0.0F, -6.0F), AnimationChannel.Interpolations.CATMULLROM)
			))
			.addAnimation("ominous_scythe", new AnimationChannel(AnimationChannel.Targets.ROTATION,
					new Keyframe(0.0F, KeyframeAnimations.degreeVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
