...
public class RedstoneMonstrosityModel<T extends LivingEntity & IRM> extends HierarchicalModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition upper = monstrosity.addOrReplaceChild("upper", CubeListBuilder.create(), PartPose.offsetAndRotation(0.0F, -36.0F, 0.0F, 0.1309F, 0.0F, 0.0F));
		...
		PartDefinition head = upper.addOrReplaceChild("head", CubeListBuilder.create(), PartPose.offsetAndRotation(0.0F, -28.0F, -15.0F, -0.1309F, 0.0F, 0.0F));
		...
		PartDefinition bottom = head.addOrReplaceChild("bottom", CubeListBuilder.create().texOffs(98, 0).addBox(-14.0F, 0.0F, -20.0F, 28.0F, 10.0F, 21.0F, new CubeDeformation(0.0F))
				.texOffs(77, 31).addBox(-14.0F, 7.0F, -20.0F, 28.0F, 0.0F, 21.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, -1.0F, 0.1745F, 0.0F, -0.1745F));

		PartDefinition right_arm = upper.addOrReplaceChild("right_arm", CubeListBuilder.create(), PartPose.offsetAndRotation(-38.0F, -44.0F, -0.5F, -0.1595F, -0.2933F, 0.0843F));
		...
		PartDefinition right_middle = right_shoulder.addOrReplaceChild("right_middle", CubeListBuilder.create().texOffs(209, 78).addBox(-11.0F, 3.0F, -13.0F, 22.0F, 22.0F, 16.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-18.0F, 8.0F, 4.5F, -0.1299F, 0.0226F, 0.0843F));

		PartDefinition right_hand = right_middle.addOrReplaceChild("right_hand", CubeListBuilder.create().texOffs(182, 116).addBox(-14.5F, -1.0F, -13.5F, 29.0F, 20.0F, 27.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.5F, 26.0F, -4.5F, -0.3054F, 0.0F, 0.0F));

		PartDefinition r_finger_s = right_hand.addOrReplaceChild("r_finger_s", CubeListBuilder.create().texOffs(182, 163).addBox(-1.5F, 1.0F, -2.5F, 3.0F, 10.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-8.0F, 18.0F, 4.0F, 0.0F, 0.0F, -0.1309F));

		PartDefinition r_finger_n = right_hand.addOrReplaceChild("r_finger_n", CubeListBuilder.create().texOffs(182, 163).addBox(-1.5F, 1.0F, -2.5F, 3.0F, 10.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-8.0F, 18.0F, -5.0F, 0.0F, 0.0F, 0.3054F));

		PartDefinition r_thumb = right_hand.addOrReplaceChild("r_thumb", CubeListBuilder.create().texOffs(198, 163).addBox(-1.5F, 1.0F, -2.5F, 3.0F, 10.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(7.0F, 18.0F, 1.0F, 0.0F, 0.0F, -0.1309F));

		PartDefinition left_arm = upper.addOrReplaceChild("left_arm", CubeListBuilder.create(), PartPose.offsetAndRotation(38.0F, -44.0F, 0.0F, -0.1421F, -0.1119F, 0.1477F));
		...
		PartDefinition left_middle = left_shoulder.addOrReplaceChild("left_middle", CubeListBuilder.create().texOffs(209, 78).mirror().addBox(-11.0F, 3.0F, -13.0F, 22.0F, 22.0F, 16.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(17.0F, 8.0F, 4.5F, -0.474F, -0.0375F, -0.1665F));

		PartDefinition left_hand = left_middle.addOrReplaceChild("left_hand", CubeListBuilder.create().texOffs(294, 128).addBox(-14.5F, -1.0F, -13.5F, 29.0F, 20.0F, 27.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.5F, 26.0F, -4.5F, -0.1745F, 0.0F, 0.0F));
		...
		PartDefinition l_thumb = left_hand.addOrReplaceChild("l_thumb", CubeListBuilder.create().texOffs(198, 163).addBox(-1.5F, 1.0F, -2.5F, 3.0F, 10.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-7.0F, 18.0F, 1.0F, 0.1052F, -0.5828F, -0.2671F));

		PartDefinition pelvis = monstrosity.addOrReplaceChild("pelvis", CubeListBuilder.create().texOffs(0, 139).addBox(-14.0F, -5.5F, -10.5F, 28.0F, 11.0F, 21.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -30.5F, 0.5F, 0.0873F, 0.0F, 0.0F));
