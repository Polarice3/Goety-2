...
/**
 * Based of codes from @TeamTwilight: <a href="https://github.com/TeamTwilight/twilightforest/blob/1.19.2/src/main/java/twilightforest/client/model/block/leaves/BakedLeavesModel.java">...</a>
 */
