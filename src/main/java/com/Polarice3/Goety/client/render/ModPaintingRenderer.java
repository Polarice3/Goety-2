...
public class ModPaintingRenderer extends EntityRenderer<ModPainting> {
   private static final ResourceLocation TEXTURES = Goety.location("textures/painting/back.png");

   public ModPaintingRenderer(EntityRendererProvider.Context p_174332_) {
      super(p_174332_);
   }

   public void render(ModPainting p_115552_, float p_115553_, float p_115554_, PoseStack p_115555_, MultiBufferSource p_115556_, int p_115557_) {
      p_115555_.pushPose();
   ...
   public ResourceLocation getTextureLocation(ModPainting p_115550_) {
      return Minecraft.getInstance().getPaintingTextures().getBackSprite().atlas().location();
   }

   private void renderPainting(PoseStack p_115559_, VertexConsumer p_115560_, ModPainting p_115561_, int p_115562_, int p_115563_, TextureAtlasSprite p_115564_, TextureAtlasSprite p_115565_) {
