...
public class SnapFungusRenderer extends EntityRenderer<SnapFungus> {
    private static final ResourceLocation TEXTURE = Goety.location("textures/entity/projectiles/snap_fungus.png");
    private final BlastFungusModel<SnapFungus> model;
    ...
    public void render(SnapFungus p_116177_, float p_116178_, float p_116179_, PoseStack p_116180_, MultiBufferSource p_116181_, int p_116182_) {
        p_116180_.pushPose();
