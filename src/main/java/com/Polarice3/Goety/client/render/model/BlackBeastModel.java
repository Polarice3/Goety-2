...
public class BlackBeastModel<T extends BlackBeast> extends HierarchicalModel<T> {
	...
	public void setupAnim(T entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
		...
		if (entity.canAnimateMove()) {
			if (entity.isInWater()){
				ModModelUtils.animateWalk(this, BlackBeastAnimations.SWIM, limbSwing, limbSwingAmount, 2.5F, 20.0F);
			} else if (entity.getPose() == Pose.CROUCHING){
				ModModelUtils.animateWalk(this, BlackBeastAnimations.CROUCH_WALK, limbSwing, limbSwingAmount, 2.5F, 20.0F);
			} else {
				ModModelUtils.animateWalk(this, BlackBeastAnimations.WALK, limbSwing, limbSwingAmount, 2.5F, 20.0F);
			}
		}
