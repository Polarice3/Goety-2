		...
		if (!entity.isDeadOrDying()) {
			...
			if (!entity.isMeleeAttacking()) {
				...
				if (entity.isClimbing()){
					ModModelUtils.animateWalk(this, WightAnimations.CLIMB, limbSwing, limbSwingAmount, 2.5F, 1.0F);
				} else {
					ModModelUtils.animateWalk(this, WightAnimations.WALK, limbSwing, limbSwingAmount, 5.0F, 1.0F);
				}
			} else if (!isCrouching) {
