...
public class DarkHatRenderer implements ICurioRenderer {
    private final ResourceLocation texture;
    private final DarkHatModel model;

    public DarkHatRenderer(DarkHatModel model) {
        this(Goety.location("textures/models/armor/dark_hat.png"), model);
    }

    public DarkHatRenderer(ResourceLocation texture, DarkHatModel model) {
