...
public class WhispererModel<T extends Whisperer> extends HierarchicalModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition top_part = whisperer.addOrReplaceChild("top_part", CubeListBuilder.create(), PartPose.offsetAndRotation(0.0F, 10.0F, 0.0F, 0.1745F, 0.0F, 0.0F));

		PartDefinition head = top_part.addOrReplaceChild("head", CubeListBuilder.create(), PartPose.offsetAndRotation(0.0F, -14.0F, 0.0F, 0.0F, -0.4363F, 0.0F));
		...
		PartDefinition top_jaw = head.addOrReplaceChild("top_jaw", CubeListBuilder.create().texOffs(0, 35).addBox(-5.5F, -8.0F, -10.0F, 11.0F, 8.0F, 10.0F, new CubeDeformation(0.0F))
				.texOffs(32, 45).addBox(-5.5F, -6.0F, -10.0F, 11.0F, 0.0F, 10.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 4.5F, -0.0873F, 0.0F, 0.0F));
		...
		PartDefinition right_arm = top_part.addOrReplaceChild("right_arm", CubeListBuilder.create(), PartPose.offsetAndRotation(-4.0F, -12.0F, 0.5F, -0.4363F, 0.0F, 0.1309F));
		...
		PartDefinition left_arm = top_part.addOrReplaceChild("left_arm", CubeListBuilder.create(), PartPose.offsetAndRotation(4.0F, -12.0F, 0.5F, -0.2618F, 0.0F, -0.1309F));
		...
		PartDefinition right_leg = whisperer.addOrReplaceChild("right_leg", CubeListBuilder.create().texOffs(13, 18).addBox(-1.5F, 0.0F, -1.5F, 3.0F, 14.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-2.5F, 10.0F, 0.5F, 0.3054F, 0.0F, 0.0F));
		...
		PartDefinition left_leg = whisperer.addOrReplaceChild("left_leg", CubeListBuilder.create().texOffs(1, 18).addBox(-1.5F, 0.0F, -1.5F, 3.0F, 14.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.5F, 10.0F, 0.5F, -0.1309F, 0.0F, 0.0F));
