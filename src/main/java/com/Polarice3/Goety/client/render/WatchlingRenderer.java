...
public class WatchlingRenderer<T extends AbstractWatchling> extends MobRenderer<T, WatchlingModel<T>> {
    ...
    private static final ResourceLocation SERVANT_LOCATION = Goety.location("textures/entity/enderling/watchling_servant.png");
    ...
    public static class GlowLayer<T extends AbstractWatchling, M extends WatchlingModel<T>> extends EyesLayer<T, M> {
        private static final RenderType RENDER_TYPE = RenderType.eyes(Goety.location("textures/entity/enderling/watchling_glow.png"));
