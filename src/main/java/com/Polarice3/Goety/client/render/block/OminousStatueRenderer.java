...
public class OminousStatueRenderer implements BlockEntityRenderer<OminousStatueBlockEntity> {
    public static final ResourceLocation TEXTURE = Goety.location("textures/entity/statue/ominous_statue.png");
    private final ModelPart statue;

    public OminousStatueRenderer(BlockEntityRendererProvider.Context ctx) {
        ModelPart modelpart = ctx.bakeLayer(ModBlockLayer.OMINOUS_STATUE);
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition right_arm = body.addOrReplaceChild("right_arm", CubeListBuilder.create(), PartPose.offsetAndRotation(-4.0F, 1.0F, -2.0F, -1.3063F, -0.5405F, -0.0053F));

        PartDefinition right_shoulder = right_arm.addOrReplaceChild("right_shoulder", CubeListBuilder.create().texOffs(22, 75).addBox(-4.5F, 0.5F, -2.25F, 3.0F, 3.0F, 4.0F, new CubeDeformation(0.3F)), PartPose.offset(1.0F, 0.0F, 0.0F));
        ...
        PartDefinition right_gauntlet = right_arm.addOrReplaceChild("right_gauntlet", CubeListBuilder.create().texOffs(6, 66).addBox(-4.0F, -1.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(-0.01F)), PartPose.offset(1.0F, -2.0F, 0.0F));
        ...
        PartDefinition left_arm = body.addOrReplaceChild("left_arm", CubeListBuilder.create(), PartPose.offsetAndRotation(4.0F, 1.0F, -2.0F, -1.3063F, 0.5405F, 0.0053F));
        ...
        PartDefinition left_shoulder = left_arm.addOrReplaceChild("left_shoulder", CubeListBuilder.create().texOffs(22, 64).addBox(5.0F, -25.5F, -3.0F, 4.0F, 4.0F, 6.0F, new CubeDeformation(0.0F))
                ...
                .texOffs(22, 75).addBox(5.5F, -21.5F, -2.25F, 3.0F, 3.0F, 4.0F, new CubeDeformation(0.3F)), PartPose.offset(-5.0F, 22.0F, 0.0F));

        PartDefinition left_gauntlet = left_arm.addOrReplaceChild("left_gauntlet", CubeListBuilder.create().texOffs(6, 66).mirror().addBox(0.0F, -2.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(-0.01F)).mirror(false), PartPose.offset(-1.0F, -1.0F, 0.0F));
        ...
        PartDefinition sword = statue.addOrReplaceChild("sword", CubeListBuilder.create().texOffs(0, 86).addBox(0.0F, 0.0F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(0, 82).addBox(-1.0F, -1.0F, -0.5F, 3.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(0, 84).addBox(0.0F, -2.0F, -0.5F, 3.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(8, 82).addBox(1.0F, -3.0F, -0.5F, 3.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(8, 84).addBox(2.0F, -4.0F, -0.5F, 3.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(16, 82).addBox(3.0F, -5.0F, -0.5F, 4.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(16, 84).addBox(4.0F, -6.0F, -0.5F, 4.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(10, 86).addBox(3.0F, -7.0F, -0.5F, 6.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(26, 82).addBox(5.0F, -8.0F, -0.5F, 4.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(26, 84).addBox(6.0F, -9.0F, -0.5F, 4.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(24, 86).addBox(8.0F, -10.0F, -0.5F, 3.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(24, 86).addBox(9.0F, -11.0F, -0.5F, 3.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(24, 86).addBox(10.0F, -12.0F, -0.5F, 3.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(24, 86).addBox(11.0F, -13.0F, -0.5F, 3.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(24, 86).addBox(12.0F, -14.0F, -0.5F, 3.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(24, 86).addBox(13.0F, -15.0F, -0.5F, 3.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(24, 86).addBox(14.0F, -16.0F, -0.5F, 3.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(24, 86).addBox(15.0F, -17.0F, -0.5F, 3.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(24, 86).addBox(16.0F, -18.0F, -0.5F, 3.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(24, 86).addBox(17.0F, -19.0F, -0.5F, 3.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(8, 88).addBox(18.0F, -20.0F, -0.5F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(4, 88).addBox(8.0F, -12.0F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(4, 88).addBox(11.0F, -9.0F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(4, 86).addBox(6.0F, -4.0F, -0.5F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(4, 86).addBox(2.0F, -8.0F, -0.5F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(0, 88).addBox(7.0F, -3.0F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -23.75F, -8.0F, 0.0F, 0.0F, 2.3562F));

        return LayerDefinition.create(meshdefinition, 64, 128);
    }

    @Override
    public void render(@Nullable OminousStatueBlockEntity pBlockEntity, float pPartialTicks, PoseStack pStack, MultiBufferSource pBuffer, int pLight, int pOverlay) {
        pStack.pushPose();
    ...
    public boolean shouldRenderOffScreen(OminousStatueBlockEntity p_112138_) {
        return true;
    }

    public boolean shouldRender(OminousStatueBlockEntity p_173531_, Vec3 p_173532_) {
