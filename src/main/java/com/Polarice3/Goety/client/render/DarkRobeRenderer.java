...
public class DarkRobeRenderer implements ICurioRenderer {
    private final ResourceLocation texture;
    private final DarkRobeModel model;

    public DarkRobeRenderer(DarkRobeModel model) {
        this(Goety.location("textures/models/armor/dark_robe.png"), model);
    }

    public DarkRobeRenderer(ResourceLocation texture, DarkRobeModel model) {
