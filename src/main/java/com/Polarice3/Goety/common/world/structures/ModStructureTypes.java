...
public class ModStructureTypes {
    ...
    public static RegistryObject<StructureType<WreckedMansionStructure>> WRECKED_MANSION = STRUCTURE_TYPE.register("wrecked_mansion", () -> () -> WreckedMansionStructure.CODEC);
