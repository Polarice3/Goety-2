...
public class ModFeatures {
    ...
    public static final RegistryObject<Feature<NetherForestVegetationConfig>> RED_MOSS_VEGETATION = FEATURES.register("red_moss_vegetation", () -> new RedMossVegetationFeature(NetherForestVegetationConfig.CODEC));
