...
public class ModEntityType {
    ...
    public static final RegistryObject<EntityType<ReprobateCarry>> REPROBATE_CARRY = register("reprobate_carry",
    ...
    public static final RegistryObject<EntityType<Reprobate>> REPROBATE = register("reprobate",
    ...
    public static final RegistryObject<EntityType<Heresiarch>> HERESIARCH = register("heresiarch",
    ...
    public static final RegistryObject<EntityType<HostileZombieVindicator>> ZOMBIE_VINDICATOR = register("hostile_zombie_vindicator",
            EntityType.Builder.of(HostileZombieVindicator::new, MobCategory.MONSTER)
                    .sized(0.6F, 1.95F)
                    .clientTrackingRange(8));

    public static final RegistryObject<EntityType<HostileSkeletonPillager>> SKELETON_PILLAGER = register("hostile_skeleton_pillager",
    ...
    public static final RegistryObject<EntityType<ZombieRoyalGuardServant>> BLACKGUARD_VARIANT_SERVANT = register("blackguard_variant_servant",
    ...
    public static final RegistryObject<EntityType<SpriteMob>> SPRITE = register("sprite",
            EntityType.Builder.of(SpriteMob::new, MobCategory.MONSTER)
                    .sized(0.5F, 0.5F)
                    .clientTrackingRange(8));

    public static final RegistryObject<EntityType<BurningHoglin>> BURNING_HOGLIN = register("burning_hoglin",
    ...
    public static final RegistryObject<EntityType<ImperialGuardServant>> IMPERIAL_GUARD_SERVANT = register("imperial_guard_servant",
    ...
    public static final RegistryObject<EntityType<RoyalGuardServant>> ROYAL_GUARD_SERVANT = register("royal_guard_servant",
    ...
    public static final RegistryObject<EntityType<ReprobateServant>> REPROBATE_SERVANT = register("reprobate_servant",
    ...
    public static final RegistryObject<EntityType<EffectBlastTrap>> EFFECT_BLAST_TRAP = register("effect_blast_trap",
