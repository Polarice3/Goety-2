...
public class BoundEvoker extends AbstractBoundIllager{
    ...
    protected void registerGoals() {
        super.registerGoals();
        this.goalSelector.addGoal(1, new BoundEvoker.EvokerCastingSpellGoal());
        this.goalSelector.addGoal(2, new AvoidTargetGoal<>(this, LivingEntity.class, 8.0F, 0.6D, 1.0D));
        this.goalSelector.addGoal(4, new BoundEvoker.EvokerSummonSpellGoal());
        this.goalSelector.addGoal(5, new BoundEvoker.EvokerAttackSpellGoal());
        this.goalSelector.addGoal(6, new BoundEvoker.EvokerWololoSpellGoal());
