    ...
    protected void onHit(HitResult pResult) {
        ...
        if (!this.level.isClientSide) {
            ...
            if (this.level instanceof ServerLevel serverLevel) {
                ...
                DustCloudParticleOption cloudParticleOptions = new DustCloudParticleOption(new Vector3f(Vec3.fromRGB24(0x1f1f1f)), 1.0F);
                DustCloudParticleOption cloudParticleOptions2 = new DustCloudParticleOption(new Vector3f(Vec3.fromRGB24(0x171717)), 1.0F);
                for (int i = 0; i < 2; ++i) {
            ...
            new SpellExplosion(this.level, this.getOwner() != null ? this.getOwner() : this, DamageSource.indirectMagic(this, this.getOwner()), vec3.x, vec3.y, vec3.z, 1.0F, 0){
                @Override
