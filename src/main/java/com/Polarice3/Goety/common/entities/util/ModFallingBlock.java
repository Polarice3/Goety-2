...
public class ModFallingBlock extends Entity {
    ...
    private static final EntityDataAccessor<Optional<BlockState>> BLOCK_STATE = SynchedEntityData.defineId(ModFallingBlock.class, EntityDataSerializers.BLOCK_STATE);
    ...
    protected void readAdditionalSaveData(CompoundTag compound) {
        ...
        if (blockStateCompound != null) {
            BlockState blockState = NbtUtils.readBlockState(compound.getCompound("BlockState"));
            this.setBlock(blockState);
        }
