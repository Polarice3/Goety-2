...
public abstract class AbstractBoundIllager extends Summoned {
    ...
    private AbstractBoundIllager.BoundSpell currentSpell = AbstractBoundIllager.BoundSpell.NONE;
    ...
    public AbstractBoundIllager.BoundArmPose getArmPose() {
        if (this.isCastingSpell()) {
            return AbstractBoundIllager.BoundArmPose.SPELLCASTING;
        } else {
            return AbstractBoundIllager.BoundArmPose.CROSSED;
        }
    }
    ...
    public void setIsCastingSpell(AbstractBoundIllager.BoundSpell p_33728_) {
        this.currentSpell = p_33728_;
        this.entityData.set(DATA_SPELL_CASTING_ID, (byte)p_33728_.id);
    }

    protected AbstractBoundIllager.BoundSpell getCurrentSpell() {
        return !this.level.isClientSide ? this.currentSpell : AbstractBoundIllager.BoundSpell.byId(this.entityData.get(DATA_SPELL_CASTING_ID));
    }
    ...
    public void tick() {
        ...
        if (this.level.isClientSide && this.isCastingSpell() && this.getCurrentSpell() != BoundSpell.CLOUDLESS) {
            AbstractBoundIllager.BoundSpell spellcasterillager$illagerspell = this.getCurrentSpell();
    ...
    protected static enum BoundSpell {
        ...
        public static AbstractBoundIllager.BoundSpell byId(int p_33759_) {
            for(AbstractBoundIllager.BoundSpell spellcasterillager$illagerspell : values()) {
    ...
    protected class BoundCastingSpellGoal extends Goal {
        ...
        public void stop() {
            super.stop();
            AbstractBoundIllager.this.setIsCastingSpell(AbstractBoundIllager.BoundSpell.NONE);
        }
    ...
    protected abstract class BoundUseSpellGoal extends Goal {
        ...
        protected abstract AbstractBoundIllager.BoundSpell getSpell();
    }
