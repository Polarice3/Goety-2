...
public class ModPotions {
    ...
    public static final RegistryObject<Potion> LONG_SPASMS = POTIONS.register("long_spasms", () -> new Potion("spasms", new MobEffectInstance(GoetyEffects.SPASMS.get(), 1800)));
}
