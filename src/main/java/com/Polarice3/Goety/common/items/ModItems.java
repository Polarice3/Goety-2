...
//    public static final RegistryObject<Item> UNHOLY_FABRIC = ITEMS.register("unholy_fabric", () -> new Item(new Item.Properties().tab(Goety.TAB).fireResistant()));
    ...
    public static final RegistryObject<Item> WITHERED_MANUSCRIPT = ITEMS.register("withered_manuscript", () -> new Item(new Item.Properties().tab(Goety.TAB).fireResistant()));
    public static final RegistryObject<Item> SHROUDED_BLUEPRINT = ITEMS.register("shrouded_blueprint", () -> new Item(new Item.Properties().tab(Goety.TAB).fireResistant()));
    ...
    public static final RegistryObject<SingleStackItem> NETHER_CROWN = ITEMS.register("nether_crown", () -> new MagicCrownItem(new Item.Properties().tab(Goety.TAB).fireResistant().stacksTo(1), SpellType.NETHER));
