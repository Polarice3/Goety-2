...
public class ModDamageTypeTagsProvider extends TagsProvider<DamageType> {
    ...
    protected void addTags(HolderLookup.Provider provider) {
        this.tag(DamageTypeTags.BYPASSES_ARMOR).add(ModDamageSource.PHOBIA, ModDamageSource.DOOM, ModDamageSource.DIRECT_FREEZE, ModDamageSource.INDIRECT_FREEZE, ModDamageSource.ICE_BOUQUET, ModDamageSource.MAGIC_BOLT, ModDamageSource.WIND_BLAST, ModDamageSource.CHOCK);
        ...
        this.tag(NO_KNOCKBACK).add(ModDamageSource.ICE_BOUQUET, ModDamageSource.FIRE_BREATH, ModDamageSource.FROST_BREATH, ModDamageSource.MAGIC_BOLT, ModDamageSource.SOUL_LEECH, ModDamageSource.CHOCK);
    }
