...
public class ClientInitEvents {
    ...
    public static void registerFactories(RegisterParticleProvidersEvent event) {
        ...
        event.register(ModParticleTypes.CHANT.get(), FlameParticle.Provider::new);
        ...
        event.register(ModParticleTypes.RISING_ENCHANT.get(), RisingRollingParticle.Provider::new);
        event.register(ModParticleTypes.ROLLING_ENCHANT.get(), RollingParticle.EnchantProvider::new);
        ...
        event.register(ModParticleTypes.BLOSSOM_THORN_INDICATOR.get(),
