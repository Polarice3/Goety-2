...
public class ClientSideInit extends SidedInit {
    ...
    public void setupParticles(RegisterParticleProvidersEvent event) {
        ...
        event.registerSpriteSet(ModParticleTypes.SMALL_FIRE_REVERSED.get(), FireParticle.SmallReversedProvider::new);
        event.registerSpriteSet(ModParticleTypes.BIG_FIRE.get(), FireParticle.ReversibleProvider::new);
        ...
        event.registerSpriteSet(ModParticleTypes.BIG_SOUL_FIRE.get(), FireParticle.ReversibleProvider::new);
        ...
        event.registerSpriteSet(ModParticleTypes.NECRO_FIRE.get(), FireParticle.ReversibleProvider::new);
        event.registerSpriteSet(ModParticleTypes.NECRO_FIRE_DROP.get(), FireParticle.Provider::new);
        event.registerSpriteSet(ModParticleTypes.SMALL_NECRO_FIRE.get(), FireParticle.SmallReversibleProvider::new);
        ...
        event.registerSpriteSet(ModParticleTypes.FROST.get(), FrostParticle.Provider::new);
        event.registerSpriteSet(ModParticleTypes.SMALL_FROST.get(), FrostParticle.SmallProvider::new);
