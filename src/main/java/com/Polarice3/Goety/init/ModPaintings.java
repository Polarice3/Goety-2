...
public class ModPaintings {
    ...
    public static final RegistryObject<PaintingVariant> KOGANUSAN = PAINTING_VARIANTS.register("koganusan", () -> new PaintingVariant(32, 32));
    public static final RegistryObject<PaintingVariant> GLACIAL_FLOWER = PAINTING_VARIANTS.register("glacial_flower", () -> new PaintingVariant(32, 32));
