...
public class ModLootInject {
    ...
    private static final List<String> CHEST_TABLES = List.of("abandoned_mineshaft", "nether_bridge", "pillager_outpost", "simple_dungeon", "stronghold_crossing", "woodland_mansion");
